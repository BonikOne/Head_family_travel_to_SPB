...
define config.name = _("Travel to SPB")
...
define config.save_directory = "TraveltoSPB-1744474480"
...
define config.keymap['focus_next'] = []
define config.keymap['focus_previous'] = []
